...
* 课件
::: details 电路交换
<iframe :src="$withBase('/pdf/计算机网络/L05数据交换-电路交换.pdf')" width="100%" height="600"></iframe>
:::
::: details 多路复用
<iframe :src="$withBase('/pdf/计算机网络/L06多路复用.pdf')" width="100%" height="600"></iframe>
:::

::: details 数据交换-报文、分组交换

* 1

<iframe :src="$withBase('/pdf/计算机网络/L07数据交换-报文、分组交换-01.pdf')" width="100%" height="600"></iframe>

* 2

<iframe :src="$withBase('/pdf/计算机网络/L07数据交换-报文、分组交换-02.pdf')" width="100%" height="600"></iframe>
:::
...
* $N^2$ 链路问题:两两相连
  * 随着主机设备的增加，技术上难以实现
  <!--sec data-title="两两相连示意图" data-id="section20210410111111" data-show=true ces-->
...
* 为了减小两两相连的复杂性，引入了交换设备
  <!--sec data-title="交换设备示意图" data-id="section20210410125806" data-show=true ces-->  
...
* 为了保证连通性和适应不同的网络规模，将交换设备互联起来，形成交换网络
  ...
  <!--sec data-title="交换网络示意图" data-id="section20210410125906" data-show=true ces-->
...
* 动态转接
  <!--sec data-title="动态转接示意图" data-id="section20210410111451" data-show=true ces-->
...
* **动态分配传输资源**
  * 从交换网络的层面上看
  <!--sec data-title="动态分配传输资源示意图" data-id="section20210410125547" data-show=true ces-->
...
<!--sec data-title="电路交换示意图" data-id="section20210410111642" data-show=true ces-->
...
<!--sec data-title="电路交换网络示意图" data-id="section20210410112001" data-show=true ces-->
...
* 多路复用(multiplexing)，简称**复用**，是通信技术中的基本概念
  ...
  <!--sec data-title="多路复用示意图" data-id="section20210410130558" data-show=true ces-->
  ![20210410130620-2021-04-10-13-06-20](https://cdn.jsdelivr.net/gh/sbwcwso/PicBed@master/20210410130620-2021-04-10-13-06-20.png) <!--endsec-->
...
<!--sec data-title="频分多路复用原理图" data-id="section20210410130917" data-show=true ces-->
...
<!--sec data-title="频率多路复用示意图" data-id="section20210410131050" data-show=true ces-->
...
* 时分复用则是将时间划分为一段段等长的**时分复用帧**（TDM 帧），每个用户在每个 TDM 帧中占用固定序号的时隙
  <!--sec data-title="时分复用帧示意图" data-id="section20210410131241" data-show=true ces-->
...
<!--sec data-title="时分多路复用示意图" data-id="section20210410131304" data-show=true ces-->
* 四个用户 A, B, C, D  
...
<!--sec data-title="波分复用示意图" data-id="section20210410131412" data-show=true ces-->
...
* 每个用户分配一个唯一的 **mbit 码片序列**(chippingsequence)，其中“0”用“**-1**”表示、“1”用“**+1**”表示，例如：
...
<!--sec data-title="码分多路复用编/解码举例" data-id="section20210410132326" data-show=true ces-->
* 单用户
...
* 报文：源（应用）发送信息整体
  <!--sec data-title="报文交换示意图" data-id="section20210410135905" data-show=true ces-->
